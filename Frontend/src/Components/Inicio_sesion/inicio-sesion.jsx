...
function MyLoginPage() {
    ...
    const [inicioSesionExitoso, setInicioSesionExitoso] = useState(false); // Nuevo estado
        ...
        if (validarFormulario()) {
            ...
            if (data.length > 0) {
                ...
                if (usuario.contraseña === contraseña) {
                    ...
                    // Guardar correo electrónico en sessionStorage
                    sessionStorage.setItem('nombreUsuario', usuario.nombre);
                    // Establecer el estado de inicio de sesión exitoso como true y guardarlo en sessionStorage
                    setInicioSesionExitoso(true);
                    sessionStorage.setItem('inicioSesionExitoso', true);
